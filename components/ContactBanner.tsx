  ...
  return (
    <section id="contacts" className="relative py-20 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(ellipse at 50% 50%, #E8195B 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            ...
            className="flex items-center gap-3 bg-gradient-to-r from-gold to-gold-dark text-black font-bold text-base px-10 py-4 rounded-full hover:opacity-90 hover:scale-105 transition-all duration-300 shadow-[0_8px_30px_rgba(232,25,91,0.25)]"
          >
